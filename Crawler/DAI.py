...
mac_addr = 'CD8600D38112'  # put here for easy to modify :-)
...
DAN.profile['dm_name']='T_Dummy_Control'   # you can change this but should also add the DM in server
DAN.profile['df_list']=['Dummy_Weather']   # Check IoTtalk to see what IDF/ODF the DM has
